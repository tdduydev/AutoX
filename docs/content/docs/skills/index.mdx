...
description: Browse built-in and installable AI agent skill packs.
---
...
<Cards>
  <Card title="Creating Custom Skills" href="/docs/skills/creating-skills" description="Build your own skill pack" />
  <Card title="Agent Hub" href="/docs/agent-hub" description="Browse and manage skills from the marketplace" />
</Cards>

...
import { getHealth, getModels, getDomains, setActiveModel as apiSetActiveModel, getAISettings, updateAISettings } from '../lib/api';

type Tab = 'overview' | 'llm' | 'rag' | 'language' | 'domains' | 'security';

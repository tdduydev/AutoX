                    ...
                    <div className="flex items-center gap-1 mt-5 mb-4">
                        {([
                            ...
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm transition font-medium ${tabView === tab.id
                        ...
                        <div className="flex items-center gap-2 mb-5">
                            {SOURCE_TABS.map(tab => (
                                <button
                                    ...
                                    className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium transition ${sourceFilter === tab.id
                                            ? 'bg-violet-600/20 text-violet-300 border border-violet-500/30'

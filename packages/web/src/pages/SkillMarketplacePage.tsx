        ...
        <div style={{ padding: '2rem', maxWidth: 1400, margin: '0 auto' }}>
            ...
            <div style={{ marginBottom: '2rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
                    ...
                    <div>
                        <h1 style={{ fontSize: '1.75rem', fontWeight: 700, color: 'var(--color-text)' }}>Skill Marketplace</h1>
            ...
            <div style={{ display: 'flex', gap: 12, marginBottom: '1.5rem', flexWrap: 'wrap' }}>
                ...
                <button
                    ...
                    style={{
                        ...
                        background: showInstalled ? 'var(--color-primary)' : 'var(--color-surface)',
                        color: showInstalled ? 'white' : 'var(--color-text)',
                    }}
                >
                    <Filter size={14} />
                    ...
                    return (
                        <button
                            ...
                            style={{
                                ...
                                background: isActive ? 'linear-gradient(135deg, #6366f1, #8b5cf6)' : 'var(--color-surface)',
            ...
            {/* Stats */}
            <div style={{ display: 'flex', gap: 8, marginBottom: '1.5rem', fontSize: '0.8rem', color: 'var(--color-text-secondary)' }}>
                ...
                {filtered.map((skill) => (
                    ...
                    >
                        ...
                        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12, marginBottom: 12 }}>
                            ...
                            <div style={{ flex: 1 }}>
                                <h3 style={{ fontSize: '1rem', fontWeight: 600, color: 'var(--color-text)' }}>{skill.name}</h3>
                                <p style={{ fontSize: '0.75rem', color: 'var(--color-text-secondary)', marginTop: 2 }}>
                                    by {skill.author} · v{skill.version}
                                </p>
                            </div>
                        </div>
                        <p style={{ fontSize: '0.825rem', color: 'var(--color-text-secondary)', lineHeight: 1.5, marginBottom: 12 }}>
                            {skill.description}
                        </p>
                ...
                >
                    ...
                    >
                        <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 20 }}>
                            ...
                            <div>
                                <h2 style={{ fontSize: '1.25rem', fontWeight: 700, color: 'var(--color-text)' }}>{selectedSkill.name}</h2>
                                <p style={{ fontSize: '0.8rem', color: 'var(--color-text-secondary)' }}>
                                    by {selectedSkill.author} · v{selectedSkill.version}
                                </p>
                            </div>
                        </div>
                        <p style={{ fontSize: '0.9rem', color: 'var(--color-text)', lineHeight: 1.6, marginBottom: 20 }}>
                            {selectedSkill.description}
                        </p>
                        <div style={{ display: 'flex', gap: 16, marginBottom: 20, fontSize: '0.85rem', color: 'var(--color-text-secondary)' }}>
